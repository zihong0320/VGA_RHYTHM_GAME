...
* **Overview**:
  * **VGA 디스플레이 출력**: FPGA 기반으로 VGA 화면에 노트(블럭)를 실시간 출력
...
<p align="center">
  <img width="80%" alt="image" src="https://github.com/user-attachments/assets/48619a5f-c973-4804-adeb-17136d3f5402" />
<br>
  <b>[ Sender Dataflow ]</b>
</p>
<br><br>
...
* **Sender Control Unit FSM**:
  <p align="center">
    <img width="80%" alt="image" src="https://github.com/user-attachments/assets/6f954c15-dbdd-400d-95e8-57578afb5b2e" />
  </p>
